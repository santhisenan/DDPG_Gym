...
actor = ActorNetwork(state_dim, action_dim, h1_actor, h2_critic, h3_actor, dropout_actor)
...
with tf.variable_scope('actor'):
    unscaled_actions = actor.predict_actions(state_ph, steps=1)
    actions = scale_actions(unscaled_actions, env.action_space.low, env.action_space.low)
